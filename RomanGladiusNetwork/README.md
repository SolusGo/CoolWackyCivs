...
Lachlan “RomanGladius” leads a tall, population-focused civilization in which every City is a Server and every point of Population is a Player. The design is a server-management game layered over Civilization V: thriving communities produce exceptional yields, while weak staffing and mishandled incidents can collapse Reputation and drive Players away.
...
The in-game Network Dashboard lists every Server and exposes its staff, roster, chat, log, Reputation band, timed bonuses, and unresolved incident. Human players choose how to resolve incidents; AI leaders staff and resolve their Servers automatically.

## Unique Unit — Server Owner

Replaces the Settler. It costs 60% more Production and consumes 2 Population when normally trained. Launching the second Server costs 100 Gold, the third costs 200, and so on. A newly launched Server receives a free Server Console, starts at 60 Reputation, and has Grand Opening (+50% Food) for 10 turns.
