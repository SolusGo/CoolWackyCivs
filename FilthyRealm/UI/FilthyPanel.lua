...
local function refresh()
    ...
    Controls.PointsButton:SetHide(not visible)
    Controls.PointsIcon:SetHide(not visible)
    ...
    IconHookup(3, 32, "FILTHY_OBJECT_ATLAS", Controls.PointsIcon)
    ...
    Controls.PointsLabel:SetText("Filthy Points: " .. points)
