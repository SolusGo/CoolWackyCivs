...
- `Cool Wacky Civs (v 2)` — an unpacked mod directory for quick iteration;
- `Cool Wacky Civs (v 2).zip` — a portable archive; and
- `Cool Wacky Civs (v 2).civ5mod` — a Civ V-compatible LZMA package.
...
The package can be inspected before installation. Its checked-in manifest is [Cool Wacky Civs (v 2).modinfo](../Cool%20Wacky%20Civs%20(v%202).modinfo), and its sole ModBuddy solution is [CoolWackyCivs.civ5sln](../CoolWackyCivs.civ5sln).
